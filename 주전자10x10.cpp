...
//
//// 카메라 위치 변수
//float cameraPosX = -wide/2;
//float cameraPosZ = wide/2;
//
//// 0번 광원 초기화 함수 (점광원)
//void InitLight0() {
//    // 광원의 각 특성을 설정
...
//    GLfloat light0_specular[] = { 0.5, 0.5, 0.5, 1.0 }; // 강한 반사광 (반짝임 효과)
//
...
//// 재질(Material) 초기화 함수
//void InitMaterial() {
//    GLfloat material_ambient[] = { 0.2, 0.2, 0.2, 1.0 }; // 주변광 제거
//    GLfloat material_diffuse[] = { 0.7, 0.7, 0.7, 1.0 }; // 확산광 반사
//    GLfloat material_specular[] = { 0.7, 0.7, 0.7, 1.0 }; // 강한 반사광
...
//        for (int j = -4; j < 6; j++) {
//            glPushMatrix();
//            glTranslated(i * 30, 5, j * 30); // 큐브 위치
...
//    if (is_running) {
//        // 카메라를 현재 방향으로 전진
//        cameraPosX += cameraDirectionX * (wide / tiles / 2);
//        cameraPosZ += cameraDirectionZ * (wide / tiles / 2);
//    }
